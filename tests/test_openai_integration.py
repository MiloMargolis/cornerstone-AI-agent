...
class TestOpenAIIntegration:
    ...
    def test_extract_lead_info_partial_information(self, client):
        ...
        message = "Looking for something around $2500, maybe 2 beds. I'm flexible on timing."
        current_data = {
            "move_in_date": "EMPTY",
            "price": "EMPTY",
            "beds": "EMPTY", 
    ...
    def test_extract_lead_info_already_has_data(self, client):
        ...
        message = "Actually, I can go up to $3500 and I'd prefer 2 bathrooms if possible."
        current_data = {
    ...
    def test_generate_response_initial_contact(self, client, sample_lead_data):
        ...
        missing_fields = ["move_in_date", "price", "beds", "baths", "location", "amenities"]
    ...
    def test_generate_response_no_robotic_confirmation(self, client, sample_lead_data):
        ...
        for test_case in test_cases:
            ...
            test_data[test_case['field']] = ""  # Ensure field is empty so it gets extracted
            
            # Determine missing fields (exclude the one being tested)
            all_required_fields = ["move_in_date", "price", "beds", "baths", "location", "amenities"]
            missing_fields = [field for field in all_required_fields if field != test_case['field']]
            ...
            if found_natural_patterns:
                ...
                print(f"ℹ️  No natural acknowledgment patterns found (this might be okay)")
            ...
            if f"your {field_name}" in response_lower or f"the {field_name}" in response_lower:
                print(f"⚠️  WARNING: Response mentions field name '{field_name}' - check if natural")
