...
class OpenAIClient:
    ...
    def generate_response(self, lead_data: Dict, incoming_message: str, missing_fields: List[str], needs_tour_availability: bool = False, missing_optional: Optional[List[str]] = None) -> str:
        ...
        if needs_tour_availability:
            ...
            phase_instructions = PHASE_CONFIGS["QUALIFICATION"].instructions.format(missing_fields=missing_fields_str)
            ...
            phase_instructions = PHASE_CONFIGS["OPTIONAL_QUESTIONS"].instructions.format(missing_optional=missing_optional_str)
        else:
    ...
    def extract_lead_info(self, message: str, current_data: Dict) -> Dict:
        ...
        context = {
            ...
            "boston_rental_experience": current_data.get("boston_rental_experience", "EMPTY"),
            "message": message
            }
